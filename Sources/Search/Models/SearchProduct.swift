...
public extension SearchProduct {

    // UUID helper: "00000000-0000-0000-0003-00000000NNNN"
    // Module prefix 0003 = Search; NNNN = sequential product number.
    private static func id(_ n: Int) -> UUID {
        UUID(uuidString: String(format: "00000000-0000-0000-0003-%012X", n))!
    }

    static let stubs: [SearchProduct] = electronics + furniture + garden + kitchen

    static var stub: SearchProduct { stubs[0] }
    ...
    static let electronics: [SearchProduct] = [
        ...
        SearchProduct(id: id(2),  name: "MacBook Air 15\"",
        ...
        SearchProduct(id: id(3),  name: "Dell XPS 15 Laptop",
        ...
        SearchProduct(id: id(4),  name: "HP Spectre x360 14\"",
        ...
        SearchProduct(id: id(5),  name: "Lenovo ThinkPad X1 Carbon",
            description: "Business ultrabook with 14-inch IPS display, Intel Core i7, and legendary keyboard.",
            price: 1399.99, category: "Electronics",
            supportsExtendedGuarantee: true),

        SearchProduct(id: id(6),  name: "LG 27\" 4K Monitor",
        ...
        SearchProduct(id: id(7),  name: "Dell UltraSharp 32\" Monitor",
        ...
        SearchProduct(id: id(8),  name: "Samsung 34\" Curved Monitor",
        ...
        SearchProduct(id: id(9),  name: "BenQ 24\" IPS Monitor",
        ...
        SearchProduct(id: id(10), name: "AOC 27\" QHD Monitor",
        ...
        SearchProduct(id: id(11), name: "Sony WH-1000XM5 Headphones",
        ...
        SearchProduct(id: id(12), name: "Apple AirPods Pro",
        ...
        SearchProduct(id: id(13), name: "Bose QuietComfort 45",
        ...
        SearchProduct(id: id(14), name: "Sennheiser HD 660S2",
        ...
        SearchProduct(id: id(15), name: "Jabra Evolve2 85",
        ...
        SearchProduct(id: id(16), name: "Sonos Era 300 Speaker",
        ...
        SearchProduct(id: id(17), name: "Bose SoundLink Max",
        ...
        SearchProduct(id: id(18), name: "JBL Charge 5 Speaker",
        ...
        SearchProduct(id: id(19), name: "Anker USB-C Hub 7-in-1",
        ...
        SearchProduct(id: id(20), name: "Logitech MX Keys Keyboard",
        ...
        SearchProduct(id: id(21), name: "Logitech MX Master 3S Mouse",
        ...
        SearchProduct(id: id(22), name: "Elgato 4K Webcam",
    ...
    static let furniture: [SearchProduct] = [
        ...
        SearchProduct(id: id(24), name: "Mesh Task Chair",
        ...
        SearchProduct(id: id(25), name: "Executive Leather Chair",
        ...
        SearchProduct(id: id(26), name: "Height-Adjustable Desk 140cm",
        ...
        SearchProduct(id: id(27), name: "Standing Desk 160cm",
        ...
        SearchProduct(id: id(28), name: "L-Shaped Corner Desk",
        ...
        SearchProduct(id: id(29), name: "Compact Writing Desk",
        ...
        SearchProduct(id: id(30), name: "Lounge Chair with Ottoman",
        ...
        SearchProduct(id: id(31), name: "Mid-Century Accent Chair",
            description: "Solid walnut legs, foam cushioning, and bouclé fabric in a timeless silhouette. Available in Natural, Charcoal, and Terracotta.",
        ...
        SearchProduct(id: id(32), name: "Reading Chair with Footrest",
        ...
        SearchProduct(id: id(33), name: "2-Seater Sofa",
        ...
        SearchProduct(id: id(34), name: "3-Seater Sofa",
        ...
        SearchProduct(id: id(35), name: "L-Shaped Corner Sofa",
        ...
        SearchProduct(id: id(36), name: "3-Shelf Bookcase",
        ...
        SearchProduct(id: id(37), name: "5-Shelf Bookcase",
        ...
        SearchProduct(id: id(38), name: "Storage Cabinet with Doors",
            description: "Two-door storage cabinet with adjustable internal shelf and push-to-open doors. Available in White, Black, and Oak.",
            price: 279.99, category: "Furniture",
            availableColours: [.init(name: "White", hex: "F5F5F5"), .init(name: "Black", hex: "1A1A1A"), .init(name: "Oak", hex: "C19A6B")]),

        SearchProduct(id: id(39), name: "Storage Box Set (4-pack)",
            description: "Set of 4 collapsible fabric boxes in graduated sizes with reinforced handles and lids.",
            price: 34.99, category: "Furniture"),

        SearchProduct(id: id(40), name: "Anti-fatigue Standing Mat",
        ...
        SearchProduct(id: id(41), name: "Office Chair Mat",
        ...
        SearchProduct(id: id(42), name: "LED Desk Lamp",
        ...
        SearchProduct(id: id(43), name: "Arc Floor Lamp",
        ...
        SearchProduct(id: id(44), name: "Monitor Riser Stand",
    ...
    static let garden: [SearchProduct] = [
        ...
        SearchProduct(id: id(46), name: "Rattan Garden Coffee Table",
        ...
        SearchProduct(id: id(47), name: "Folding Garden Chair",
        ...
        SearchProduct(id: id(48), name: "Stacking Rattan Armchair",
        ...
        SearchProduct(id: id(49), name: "Garden Lounge Chair",
        ...
        SearchProduct(id: id(50), name: "Reclining Sun Lounger",
        ...
        SearchProduct(id: id(51), name: "2-Seater Garden Bench",
        ...
        SearchProduct(id: id(52), name: "3-Seater Garden Bench",
        ...
        SearchProduct(id: id(53), name: "Rattan Bistro Set",
        ...
        SearchProduct(id: id(54), name: "6-Piece Garden Dining Set",
        ...
        SearchProduct(id: id(55), name: "Outdoor Corner Sofa Set",
        ...
        SearchProduct(id: id(56), name: "Hammock with Steel Stand",
        ...
        SearchProduct(id: id(57), name: "Garden Parasol 2.5m",
        ...
        SearchProduct(id: id(58), name: "Cantilever Parasol 3m",
        ...
        SearchProduct(id: id(59), name: "Large Planter Box",
        ...
        SearchProduct(id: id(60), name: "Raised Garden Bed 120cm",
            description: "120 cm raised planting bed in FSC-certified pre-treated pine with corner posts.",
            price: 94.99, category: "Garden"),
        SearchProduct(id: id(61), name: "Outdoor Storage Box 300L",
            description: "300-litre weather-proof storage box in UV-resistant resin, doubles as extra seating. Available in Beige and Grey.",
            price: 139.99, category: "Garden",
            availableColours: [.init(name: "Beige", hex: "D2B48C"), .init(name: "Grey", hex: "6B7280")]),
        SearchProduct(id: id(62), name: "Outdoor Rug 200×300cm",
        ...
        SearchProduct(id: id(63), name: "Solar Path Lights (set of 8)",
            description: "Set of 8 stainless steel solar lights with warm white LEDs and automatic dusk-to-dawn.",
            price: 44.99, category: "Garden"),
        SearchProduct(id: id(64), name: "Garden String Lights 10m",
        ...
        SearchProduct(id: id(65), name: "Bird Bath Pedestal",
    ...
    static let kitchen: [SearchProduct] = [
        ...
        SearchProduct(id: id(68), name: "Extending Dining Table",
        ...
        SearchProduct(id: id(69), name: "Round Pedestal Table",
        ...
        SearchProduct(id: id(70), name: "Marble-top Dining Table",
        ...
        SearchProduct(id: id(73), name: "Padded Dining Chair (set of 4)",
        ...
        SearchProduct(id: id(74), name: "Faux Leather Dining Chair (set of 2)",
        ...
        SearchProduct(id: id(75), name: "Stackable Dining Chair (set of 4)",
        ...
        SearchProduct(id: id(76), name: "Upholstered Dining Bench",
        ...
        SearchProduct(id: id(77), name: "Adjustable Bar Stool (set of 2)",
        ...
        SearchProduct(id: id(78), name: "Fixed-Height Bar Stool (set of 4)",
        ...
        SearchProduct(id: id(79), name: "Kitchen Island on Wheels",
            ...
            availableColours: [.init(name: "White", hex: "F5F5F5"), .init(name: "Black", hex: "1A1A1A"), .init(name: "Natural Oak", hex: "C19A6B")]),
        SearchProduct(id: id(80), name: "High Bar Table",
        ...
        SearchProduct(id: id(81), name: "Corner Bench Dining Set",
        ...
        SearchProduct(id: id(82), name: "Sideboard Buffet Cabinet",
            ...
            price: 479.99, category: "Kitchen",
            availableColours: [.init(name: "Natural Oak", hex: "C19A6B"), .init(name: "Black", hex: "1A1A1A"), .init(name: "White", hex: "F5F5F5")]),
        SearchProduct(id: id(83), name: "Display Hutch Cabinet",
            ...
            availableColours: [.init(name: "Natural Oak", hex: "C19A6B"), .init(name: "Black", hex: "1A1A1A")]),
        SearchProduct(id: id(84), name: "Wine Rack 12-bottle",
        ...
        SearchProduct(id: id(85), name: "Kitchen Trolley on Wheels",
        ...
        SearchProduct(id: id(86), name: "Wall-Mounted Pot Rack",
        ...
        SearchProduct(id: id(87), name: "Bar Cabinet with Glass Doors",
        ...
        SearchProduct(id: id(88), name: "Extendable Bench Seat",
            description: "Solid pine bench extending 140–180 cm, seats 3–4, with protective wax finish. Available in Natural Pine, Black, and White.",
