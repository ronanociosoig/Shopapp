...
struct AccountRepositoryReplayTests {
    ...
    func fetchProfileDecodesRealResponse() async throws {
        ...
        let repo    = DefaultAccountRepository(client: DefaultNetworkClient())
    ...
    func fetchAddressesDecodesRealResponse() async throws {
        ...
        let repo      = DefaultAccountRepository(client: DefaultNetworkClient(), addressStore: InMemoryAddressStore())
